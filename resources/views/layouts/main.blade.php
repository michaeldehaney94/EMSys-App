...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - System Mgmt Collapse Menu -->
            <li class="nav-item">
            ...
            <!-- Nav Item - User Mgmt Collapse Menu -->
            <li class="nav-item">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Begin Page Content -->
                {{-- User.index layout page will populate here when link is clicked --}}
            ...
            <footer class="sticky-footer bg-white mt-5">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy;2021 EMSys | Employee Management System</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
